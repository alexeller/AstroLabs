...
Dag 3 is the "crazy" dag, a hypothetical dag utilizing many datasources, forking parallel processing, and branching to make a very unpleasant process to follow. It resembles an realtime dataflow of inbound data being cleaned, run through fraud detection, aggregated for reporting, with replication processes, a monitoring process, and a sampler process.
